...
const items = [
  {
    ...
    context: "Kraft paper · Biodegradable · Full-color brand print",
    product: "Mailer Bags",
  },
  {
    image:   galleryShipping,
    label:   "Poly Shipping Bags",
    context: "Tear-resistant poly · Waterproof · Ideal for e-commerce",
    product: "Mailer Bags",
  },
  {
    image:   galleryPouches,
    label:   "Custom Stand-Up Pouches",
    context: "Lightweight · Window panel option · Food safe materials",
    product: "Pouches",
  },
  {
    image:   galleryInsert2,
    label:   "Custom Box Inserts",
    context: "Custom-fit foam or cardboard · Secure product protection",
    product: "Rigid Boxes",
  },
];
        ...
        <div className="container">
          ...
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="mt-4 text-muted-foreground text-lg">
              A sample of packaging types we produce. Each one custom designed and built to order.
            </p>
          </div>
