...
const personas = [
  {
    ...
    badge: "New & Growing Brands",
    title: "Just Starting Out",
    body: "Get your packaging right from the start. Full structural design, 3D mockup, and a dedicated contact included from your very first order.",
  },
  {
    icon: <TrendingUp className="w-6 h-6" />,
    badge: "100–10,000+ units",
    title: "Ready to Scale",
    body: "High-volume runs with dedicated account management, strict QC inspection, and consistent delivery.",
  },
  {
    icon: <Leaf className="w-6 h-6" />,
    badge: "Eco-Friendly Options",
    title: "Eco-First Brands",
    body: "Sustainable, recyclable, and eco-friendly packaging options available across product lines.",
  },
];
