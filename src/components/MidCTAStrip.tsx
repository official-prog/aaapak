...
import { ArrowRight, CalendarClock, Package, Truck, DollarSign, FlaskConical } from "lucide-react";
import { Button } from "@/components/ui/button";
import QuoteFormDialog from "./QuoteFormDialog";
import ConsultationDialog from "./ConsultationDialog";

const guarantees = [
  { icon: <Package className="w-4 h-4" />, text: "300+ Brands Served" },
  { icon: <DollarSign className="w-4 h-4" />, text: "Factory-Direct Pricing" },
  { icon: <Truck className="w-4 h-4" />, text: "Door-to-Door Shipping" },
  { icon: <FlaskConical className="w-4 h-4" />, text: "Physical Sample on Request" },
];
