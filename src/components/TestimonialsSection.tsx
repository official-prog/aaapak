...
const testimonials = [
  { name: "Sarah Mitchell", role: "Brand Manager, Luxe Beauty Co.", text: "AAAPAK transformed our brand perception. The custom rigid boxes are stunning and our unboxing experience has become a viral moment on social media." },
  ...
  { name: "David Chen", role: "CEO, TechGear Pro", text: "We switched to AAAPAK for our electronics packaging and saw a 25% increase in positive reviews mentioning packaging quality. Game changer." },
];
  ...
  <section className="py-20 md:py-28 bg-eco-warm">
    <div className="container">
      <div className="text-center max-w-2xl mx-auto mb-14">
        ...
        <p className="mt-4 text-muted-foreground text-lg">Join 3,000+ brands that trust AAAPAK for their packaging needs.</p>
      </div>
