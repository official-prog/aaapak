...
const moqTable = (
  <>
    <p className="mb-3 text-muted-foreground text-sm">MOQ varies by product type, size, printing, and materials. We offer flexibility for first-time clients and small businesses whenever possible. Contact us if you have a specific quantity in mind.</p>
    {moqTableContent}
  </>
);
...
const faqs: { q: string; a: ReactNode }[] = [
  ...
  },
  {
    ...
    a: "Typical turnaround is 15–25 business days, depending on product type, order quantity, and customization. Production begins after your design is approved. Peak periods may affect timelines. Contact your Product Specialist for a timeline specific to your order.",
  },
  {
  ...
  },
  {
    ...
    a: "Placing a repeat order is very simple. You may contact your original Product Specialist or send your request to aslam@aaapak.com or call +1 888 228 8165 (Monday to Friday, 9:30am to 5:00pm EST). A member of our team will assist you promptly with confirming and processing your reorder.",
  },
  {
  ...
  <div className="space-y-3">
    {items.map((faq, i) => (
      <Accordion key={i} type="single" collapsible>
        <AccordionItem
          value="item"
          className="bg-secondary rounded-xl border border-border px-5 data-[state=open]:border-primary/30 data-[state=open]:shadow-sm transition-all duration-200"
        >
          <AccordionTrigger className="text-left font-semibold text-foreground hover:no-underline py-4 text-sm md:text-base gap-4">
            {faq.q}
          </AccordionTrigger>
