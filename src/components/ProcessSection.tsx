...
const steps = [
  {
    ...
    desc: "Share your dimensions, materials, and brand specs. We create a 3D mockup within 48 to 72 hours.",
    stat: "48–72h",
  ...
  },
  {
    ...
    desc: "Your order enters production at our certified facility. Strict QC inspection before shipping.",
    stat: "QC",
  ...
  },
  {
    ...
    desc: "Tracked freight to any USA or Canada address. Average total time: 15–25 business days.",
    stat: "Tracked",
    statLabel: "Door-to-door",
