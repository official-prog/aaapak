...
const stats = [
  ...
  { value: "100", label: "Unit Minimum Order" },
...
const products = [
  ...
  },
  {
    ...
    desc: "Eco-friendly and sustainable packaging options for Canadian retailers.",
    moq: "From 100 units",
  },
  {
    name: "Food Packaging",
...
const reasons = [
  {
    ...
    desc: "Our direct factory model eliminates agency markups. Canadian brands get competitive pricing versus domestic packaging brokers. CAD invoicing available.",
  },
  {
  ...
  },
  {
    ...
    desc: "Sustainable, recyclable, and eco-friendly packaging options available across product lines for Canadian brands.",
  },
  {
    icon: <CheckCircle className="w-5 h-5" />,
    title: "3D Design Mockup in 48–72 Hours",
    desc: "We create a detailed 3D render and digital proof of your packaging within 48 to 72 hours. Review and approve before production starts, no commitment required.",
  },
];
...
const faqs = [
  {
    ...
    a: "Yes. We ship custom packaging door-to-door to all Canadian provinces and territories. Delivery takes 15–25 business days from artwork approval. Major hubs in Toronto, Vancouver, and Calgary receive priority routing.",
  },
  {
    q: "What is the minimum order quantity for Canadian orders?",
    a: "Our minimum order starts at 100 units for most products. MOQ varies depending on product type, size, and customization. Contact us for specifics on your product.",
  },
  {
  ...
  {
    q: "Do you offer eco-friendly packaging for Canadian retailers?",
    a: "Yes. We offer sustainable, recyclable, and eco-friendly packaging options. Please contact us for details on available materials and options.",
  },
  {
    q: "Do you provide a design proof before production starts?",
    a: "Yes. We provide a detailed 3D mockup and digital proof within 48 to 72 hours of your brief. You approve the design before production begins, no commitments required.",
  },
];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Custom packaging supplier for Canadian businesses. Corrugated, mailer, rigid and retail packaging from 100 units. Delivery to Ontario, BC, Alberta, Quebec and all provinces. 3D design mockup in 48–72h."
        />
        ...
        <meta property="og:description" content="Factory-direct custom packaging for Canadian brands. 100-unit MOQ, bilingual printing, CFIA-compliant materials. 3D design mockup in 48–72 hours." />
        ...
        <section className="py-16 md:py-24 bg-secondary">
          <div className="container max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Premium custom packaging delivered across Canada, Ontario, BC, Alberta, Quebec, and all provinces. Factory-direct pricing gives Canadian brands a competitive edge versus local suppliers.
            </p>
            <ul className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
              {[
                "100-unit minimum, MOQ varies by product",
                "Bilingual (English/French) printing available",
                "CFIA-compliant options available",
              ].map((p) => (
          ...
          <div className="container">
            <div className="text-center max-w-2xl mx-auto mb-14">
              ...
              <p className="mt-4 text-muted-foreground text-lg">
                Compliant materials, bilingual printing, and a 3D design mockup in 48 to 72 hours, built for Canadian businesses.
              </p>
            </div>
        ...
        <section className="py-20 bg-card border-t border-border">
          <div className="container max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Free quote in 24 hours. 3D design mockup delivered within 48 to 72 hours.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Button size="lg" className="font-semibold px-8" onClick={() => setQuoteOpen(true)}>
