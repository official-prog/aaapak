...
const compliance = [
  ...
  },
  {
    ...
    desc: "We offer sustainable, recyclable, and eco-friendly board options for food packaging.",
  },
  {
    icon: <Shield className="w-5 h-5" />,
...
const faqs = [
  ...
  },
  {
    ...
    a: "Most custom food packaging starts from 100 units. MOQ varies by product type, size, and customization. Contact us for specifics on your product.",
  },
  {
  ...
  {
    q: "Do you offer eco-friendly materials for retailers?",
    a: "Yes. We offer sustainable and eco-friendly packaging material options. Contact us for details on available eco materials for your specific product.",
  },
  {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Custom food packaging supplier for USA and Canada. FDA-compliant, BPA-free. Retail cartons, shipping boxes, meal kit packaging from 100 units. 3D design mockup in 48–72h."
        />
        ...
        <meta property="og:description" content="FDA-compliant custom food packaging from 100 units. Retail cartons, shipping boxes, meal kit packaging. Eco-friendly options available. Delivery across USA and Canada." />
        ...
        <section className="py-16 md:py-24 bg-secondary">
          <div className="container max-w-4xl mx-auto text-center px-4">
            <span className="inline-block px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-semibold mb-5 tracking-wide uppercase">
              FDA-Compliant · Food-Safe · USA & Canada
            </span>
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              FDA-compliant, food-safe packaging for CPG brands, meal kits, bakeries, and food distributors. Factory-direct pricing from 100 units, delivered across USA and Canada.
            </p>
            <ul className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
              {[
                ...
                "3D design mockup in 48 to 72 hours",
              ].map((p) => (
