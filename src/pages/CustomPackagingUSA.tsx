...
const products = [
  ...
  },
  {
    ...
    desc: "100% recyclable eco-friendly packaging for sustainability-focused USA brands.",
    moq: "From 100 units",
  },
  {
...
const reasons = [
  {
    ...
    desc: "You pay what a certified factory charges, not what a local packaging broker marks up. Our direct model delivers competitive pricing versus typical USA suppliers.",
  },
  {
...
const faqs = [
  {
    ...
    a: "Our minimum order quantity starts at 100 units for most packaging types. MOQ varies depending on product type, size, and customization. Contact us for specifics on your product.",
  },
  {
    q: "How long does custom packaging delivery take to the USA?",
    a: "Standard production and delivery to all US states takes 15–25 business days from artwork approval. Timing varies by product type and order size. Rush options are available for select product types.",
  },
  {
    q: "Do you provide a design proof before production?",
    a: "Yes. We provide a detailed 3D mockup and digital proof within 48 to 72 hours of your brief. You review and approve the design before we begin manufacturing, no commitment required.",
  },
  {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Custom packaging boxes for USA businesses. Corrugated, mailer, rigid, and retail packaging from 100 units. 15–25 business day delivery to all 50 states. 3D design mockup in 48–72h. Factory-direct pricing."
        />
        ...
        <meta property="og:description" content="Factory-direct custom packaging for USA brands. 100-unit MOQ, 3D design mockup in 48–72h, 15–25 business day delivery across all 50 states." />
      ...
      <main>
        ...
        <section className="py-16 md:py-24 bg-secondary">
          <div className="container max-w-4xl mx-auto text-center px-4">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Branded packaging with factory-direct pricing, no middlemen, no surprise fees. 3D design mockup in 48 to 72 hours before production starts.
            </p>
            <ul className="flex flex-col sm:flex-row gap-3 justify-center mb-10">
              {[
                "100-unit minimum order, MOQ varies by product",
                "15–25 business day delivery",
        ...
        <section className="py-20 bg-card border-t border-border">
          <div className="container max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-8">
              Get a free, no-obligation quote in 24 hours. 3D design mockup delivered within 48 to 72 hours.
            </p>
            <div className="flex flex-wrap gap-4 justify-center">
              <Button size="lg" className="font-semibold px-8" onClick={() => setQuoteOpen(true)}>
