...
const industries = [
  ...
  { name: "Food & Beverage", desc: "FSC-certified corrugated for CPG brands, meal kits, and retail food distribution." },
...
const faqs = [
  ...
  },
  {
    ...
    a: "Standard production and delivery to USA and Canada takes 10–15 business days from artwork approval. Rush production is available for select styles.",
  },
  {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Factory-direct custom corrugated boxes from 50 units. All styles, all flute types, full-color printing. USA & Canada delivery in 10–15 business days." />
          ...
          <div className="container">
            <div className="text-center max-w-2xl mx-auto mb-14">
              ...
              <p className="mt-4 text-muted-foreground">
                Every style available from 50 units. Custom dimensions and print on all formats.
              </p>
            </div>
